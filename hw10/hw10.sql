...
CREATE TABLE sentences AS
  SELECT 'The two siblings, ' || sib1 || ' and ' || sib2 || ', have the same size: ' || a.size FROM siblings, size_of_dogs AS a, size_of_dogs AS b WHERE sib1 = a.name AND sib2 = b.name AND a.size = b.size;
